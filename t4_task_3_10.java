...
public class t4_task_3_10 {
    public static void main(String[] args) {
        ...
        System.out.println("3D Перетин: " + intersection3D.x +" "+ intersection3D.y +" "+ intersection3D.z);
